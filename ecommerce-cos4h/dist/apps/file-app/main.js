/******/ (() => {
  ...
  \*******************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        const cloudinary_1 = __webpack_require__(
  ...
  \**************************************************/
      /***/ function (__unused_webpack_module, exports, __webpack_require__) {
        ...
        const file_app_service_1 = __webpack_require__(
          /*! ./file-app.service */ "./apps/file-app/src/file-app.service.ts",
        );
        ...
        let FileAppController = class FileAppController {
          ...
          async uploadImageProduct(file) {
            const image = await this.fileAppService.uploadImage(
              file,
              "products",
            );
        ...
        exports.FileAppController = FileAppController = __decorate(
          [
            ...
            __metadata("design:paramtypes", [
              typeof (_a =
                typeof file_app_service_1.FileAppService !== "undefined" &&
                file_app_service_1.FileAppService) === "function"
                ? _a
                : Object,
            ]),
          ],
  ...
  \**********************************************/
      /***/ function (__unused_webpack_module, exports, __webpack_require__) {
        ...
        const file_app_controller_1 = __webpack_require__(
          /*! ./file-app.controller */ "./apps/file-app/src/file-app.controller.ts",
        );
        const file_app_service_1 = __webpack_require__(
          /*! ./file-app.service */ "./apps/file-app/src/file-app.service.ts",
        );
        const cloudinary_config_1 = __webpack_require__(
          /*! ./config/cloudinary.config */ "./apps/file-app/src/config/cloudinary.config.ts",
        );
        const microservices_1 = __webpack_require__(
          /*! @nestjs/microservices */ "@nestjs/microservices",
        );
        ...
        exports.FileAppModule = FileAppModule = __decorate(
          [
            (0, common_1.Module)({
              ...
              providers: [
                file_app_service_1.FileAppService,
  ...
  \***********************************/
    ...
    const file_app_module_1 = __webpack_require__(
      /*! ./file-app.module */ "./apps/file-app/src/file-app.module.ts",
    );
    const microservices_1 = __webpack_require__(
      /*! @nestjs/microservices */ "@nestjs/microservices",
    );
    async function bootstrap() {
      const app = await core_1.NestFactory.createMicroservice(
        file_app_module_1.FileAppModule,
        {
          transport: microservices_1.Transport.KAFKA,
          options: {
            client: {
