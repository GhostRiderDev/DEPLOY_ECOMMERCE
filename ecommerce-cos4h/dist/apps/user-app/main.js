/******/ (() => {
  ...
  \*************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        const user_entity_1 = __webpack_require__(
          /*! ../entity/user.entity */ "./apps/user-app/src/entity/user.entity.ts",
        );
        ...
        exports["default"] = (0, config_1.registerAs)(
          "data-source",
          () => config,
        );
  ...
  \**************************************************/
      /***/ function (__unused_webpack_module, exports, __webpack_require__) {
        ...
        const user_app_service_1 = __webpack_require__(
          /*! ./user-app.service */ "./apps/user-app/src/user-app.service.ts",
        );
        const microservices_1 = __webpack_require__(
        ...
        let UserAppController = class UserAppController {
          ...
          async updateUser(data) {
            const response = await this.userAppService.update(
              data.id,
              data.user,
            );
            return JSON.stringify(response);
        ...
        exports.UserAppController = UserAppController = __decorate(
          [
            ...
            __metadata("design:paramtypes", [
              typeof (_a =
                typeof user_app_service_1.UserAppService !== "undefined" &&
                user_app_service_1.UserAppService) === "function"
                ? _a
                : Object,
            ]),
          ],
  ...
  \**********************************************/
      /***/ function (__unused_webpack_module, exports, __webpack_require__) {
        ...
        const user_app_controller_1 = __webpack_require__(
          /*! ./user-app.controller */ "./apps/user-app/src/user-app.controller.ts",
        );
        const user_app_service_1 = __webpack_require__(
          /*! ./user-app.service */ "./apps/user-app/src/user-app.service.ts",
        );
        const typeorm_1 = __webpack_require__(
        ...
        const data_source_1 = __webpack_require__(
          /*! ./config/data-source */ "./apps/user-app/src/config/data-source.ts",
        );
        const microservices_1 = __webpack_require__(
          /*! @nestjs/microservices */ "@nestjs/microservices",
        );
            ...
            try {
              ...
              const usersWithOrders = await Promise.all(
                users.map(async (user) => {
                  const ordersUser = await (0, rxjs_1.firstValueFrom)(
          ...
          [
            ...
            __metadata("design:paramtypes", [
              typeof (_a =
                ...
                : Object,
              typeof (_b =
                typeof microservices_1.ClientKafka !== "undefined" &&
                microservices_1.ClientKafka) === "function"
                ? _b
                : Object,
            ]),
          ],
  ...
  \***********************************/
    ...
    const user_app_module_1 = __webpack_require__(
      /*! ./user-app.module */ "./apps/user-app/src/user-app.module.ts",
    );
    const microservices_1 = __webpack_require__(
      /*! @nestjs/microservices */ "@nestjs/microservices",
    );
